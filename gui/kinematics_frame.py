...
from PySide6.QtWidgets import (QWidget, QHBoxLayout, QSplitter, QMessageBox, QScrollArea)
...
class KinematicsFrame(QWidget):
    ...
    def setup_ui(self):
        ...
        control_panel_layout = self.control_panel.findChild(QScrollArea).widget().layout()
